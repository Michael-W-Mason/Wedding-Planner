    ...
    public partial class FirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GuestLogId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    WeddingId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GuestLogs", x => x.GuestLogId);
                    table.ForeignKey(
                        name: "FK_GuestLogs_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GuestLogs_Weddings_WeddingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GuestLogs_UserId",
                table: "GuestLogs",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_GuestLogs_WeddingId",
                table: "GuestLogs",
                column: "WeddingId");
        }
